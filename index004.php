        ...
        switch ($_SESSION["user"]) 
        {
            ...
            break;
             ...
             case 4://Unidad de planeacion
                $bienvenido="Unidad de Planeación";  
            break;
        }
        include 'conexion.php';
        include 'NombreModulos.php';
    }
...
<body>
	<div class="container">
		...
		<div class="row" style="margin-top: 30px">
            <div class="container">
                <h4 style="border-bottom: solid #9C8412 ">Obras con Importe Autorizado</h4>
                            <div style="padding:40px 10px;">
                
                                <div class="col-md-4" style="text-align: center;">
                                    <a href="AltaObras.html">
                                        <img src="imagenes/nueva2.png" alt="Imagen" style="max-width: 100px;">
                                        <p><?php echo $nombreModulo[1] ?></p>
                                    </a>
                                </div>
		...
		<div class="row" style="margin-top: 30px">
			<div class="container">
                <h4 style="border-bottom: solid #9C8412 ">Reportes de Obras</h4>
                ...
                <section style="padding:10px 10px;">
                    ...
                    <div class="col-md-4" style="text-align: center;">
                        <button type="button" class="btn btn-link" data-toggle="modal" data-target="#VentanaModal3">
                            ...
                            <p style="color:#000;"><?php echo $nombreModulo[5] ?></p>
                        </button>
                    </div>
