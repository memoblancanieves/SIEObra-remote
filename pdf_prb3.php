...
<body>
	...
	<div class=""><!--padre border-padre center -->
		...
		<?php
			...
			WHERE reportes.FechaInicio>='2018-06-12' AND reportes.FechaTermino<='2018-06-18'");
			...
			if(mysqli_num_rows($resultado)>0)
			{
				...
				foreach ($resultado as $fila) 
				{
					...
					{
						?>
							<div style="width: 940px; margin: auto; margin-bottom: 5px; margin-top: 10px;">
								<img src="imagenes/logo.PNG" alt="No se encontro" style="width: 940px; height: 56px">
							</div>
						<?php
					}
