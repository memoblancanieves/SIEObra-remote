                ...
                success: function(datos)
                {
                    ...
                    for (i in datos) 
                    {
                        ...
                        <tr>
                            ...
                            <td><input type='checkbox' disabled="" name='t_recursos' id='recurso${datos[i].id}' value='${datos[i].id}'></td>
    ...
    function listaObras() //CARGA LISTA DE TIPO DE OBRA DESDE LA BASE DE DATOS
    {
            ...
            success: function(datos)
            {
                ...
                for (i in datos) 
                {
                    ...
                    t_re.innerHTML +=`
                    <tr>
                        <td><input type='checkbox' disabled="" name='t_obras' id='obra${datos[i].id}' value='${datos[i].id}'></td>
                        <td style="text-align:justify;">${datos[i].name}</td>
                ...
                $.ajax({
                    ...
                    success: function(datos)
                    {
                        ...
                        for (i in datos) 
                        {
                            info+=`
                                <tr>                                
                                    <td><input type='checkbox' name='t_recursos' id='recurso${datos[i].id}' value='${datos[i].id}' disabled=''></td>
                            `;
